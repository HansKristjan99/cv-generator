...
SYSTEM_PROMPT = (
    ...
    "natural, human-written, hiring-manager-friendly prose.\n\n"
    "HARD RULES (non-negotiable):\n"
    " - PRESERVE EVERY FACT, NUMBER, DATE, EMPLOYER, AND TITLE. Do not "
    "invent achievements, inflate metrics, or change dates. You may rephrase but "
    "not falsify.\n"
    " - PRESERVE LATEX special symbols — a very common bug is "
    ...
    "phrasing or changing the font, geometry, or margins.\n"
    ...
    "summary. Keep the job-description fit strong.\n"
    ...
    "the job description verbatim. Aim for natural, evidence-dense bullets. Very important to get rid of LLM tells and language patterns."
    "hiring managers will reject a CV they think is AI-written. Make sure you are undercover mode. \n\n"
    "WORKFLOW:\n"
