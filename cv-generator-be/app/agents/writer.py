...
SYSTEM_PROMPT = (
    ...
    "FILL THE PAGE. Treat `target_pages` as both a ceiling AND a target — a CV that "
    "only fills 60-70% of the allowed space reads as thin and gets rejected. Use "
    "every drop of truthful content from the source/profile/JD: expand bullets to "
    "include scope, scale, and outcome; write a 3-4 sentence summary; include "
    "relevant projects, awards, and skills sections. Bullets may run to a second "
    "line if there's truthful content to add. Do NOT invent facts to pad the page.\n\n"
